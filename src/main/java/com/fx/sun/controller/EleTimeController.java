...
import com.fx.sun.tools.EleTimeAnchorPage;
 ...
 * @author pscha
 */
public class EleTimeController implements Initializable, PopulateInterface {
    ...
    private static final Logger _log = LogManager.getLogger(EleTimeController.class);
    EleTimeAnchorPage eleTimeAnchorPage;
    private double lat;
    private double lon;
    
    private ResourceBundle bundle;
    
    public EleTimeController() {
    ...
    public void initialize(URL url, ResourceBundle bundle) {
        ...
        eleTimeAnchorPage = new EleTimeAnchorPage();
        borderPane.setCenter(eleTimeAnchorPage);
    ...
    private void calculate() {
        ...
        for (int i = 0; i < 24; i++) {
            for (int j = 0; j < (60 / min); j++) {
                ...
                listSun.add(new EleTimePOJO(time, azi, alti));
                ...
                listMoon.add(new EleTimePOJO(time, azi, alti));
            }
        }
        ...
        eleTimeAnchorPage.setListSun(listSun);
        eleTimeAnchorPage.setListMoon(listMoon);
        eleTimeAnchorPage.setMaxSun(maxSun);
        eleTimeAnchorPage.setMaxMoon(maxMoon);
    }
