 ...
 * @author pscha
 */
public class MoonParamsCell extends TableCell<DatePOJO, LocalDate> {
    ...
    public MoonParamsCell(double lat, double lon, LocalDate month, int hour, int min, int sec, ResourceBundle bundle) {
        this.lat = lat;
        this.lon = lon;
        this.month = month;
        this.hour = hour;
    ...
    protected void updateItem(LocalDate item, boolean empty) {
        ...
        if (empty) {
            ...
            Label lbAzi = new Label(bundle.getString("azi") + ": \t" + decimalFormat.format(moonPosition.getAzimuth()) + "°");
            Label lbAlti = new Label(bundle.getString("alti") + ": \t" + decimalFormat.format(moonPosition.getAltitude()) + "°");
            Label lbDist = new Label(bundle.getString("dist") + ": \t" + decimalFormat.format(moonPosition.getDistance()) + " km");
